...
#define GPA1(a, b) a = reinterpret_cast<decltype(a)>(GetProcAddress(glw_state.hinstOpenGL, b))
#define GPA2(a, b, c) a = b = reinterpret_cast<decltype(a)>(GetProcAddress(glw_state.hinstOpenGL, c))
...
qboolean QGL_Init(const char* dllname) {
    ...
    GPA2(qglAccum, dllAccum, "glAccum");
    GPA2(qglAlphaFunc, dllAlphaFunc, "glAlphaFunc");
    GPA2(qglAreTexturesResident, dllAreTexturesResident, "glAreTexturesResident");
    GPA2(qglArrayElement, dllArrayElement, "glArrayElement");
    GPA2(qglBegin, dllBegin, "glBegin");
    GPA2(qglBindTexture, dllBindTexture, "glBindTexture");
    GPA2(qglBitmap, dllBitmap, "glBitmap");
    GPA2(qglBlendFunc, dllBlendFunc, "glBlendFunc");
    GPA2(qglCallList, dllCallList, "glCallList");
    GPA2(qglCallLists, dllCallLists, "glCallLists");
    GPA2(qglClear, dllClear, "glClear");
    GPA2(qglClearAccum, dllClearAccum, "glClearAccum");
    GPA2(qglClearColor, dllClearColor, "glClearColor");
    GPA2(qglClearDepth, dllClearDepth, "glClearDepth");
    GPA2(qglClearIndex, dllClearIndex, "glClearIndex");
    GPA2(qglClearStencil, dllClearStencil, "glClearStencil");
    GPA2(qglClipPlane, dllClipPlane, "glClipPlane");
    GPA2(qglColor3b, dllColor3b, "glColor3b");
    GPA2(qglColor3bv, dllColor3bv, "glColor3bv");
    GPA2(qglColor3d, dllColor3d, "glColor3d");
    GPA2(qglColor3dv, dllColor3dv, "glColor3dv");
    GPA2(qglColor3f, dllColor3f, "glColor3f");
    GPA2(qglColor3fv, dllColor3fv, "glColor3fv");
    GPA2(qglColor3i, dllColor3i, "glColor3i");
    GPA2(qglColor3iv, dllColor3iv, "glColor3iv");
    GPA2(qglColor3s, dllColor3s, "glColor3s");
    GPA2(qglColor3sv, dllColor3sv, "glColor3sv");
    GPA2(qglColor3ub, dllColor3ub, "glColor3ub");
    GPA2(qglColor3ubv, dllColor3ubv, "glColor3ubv");
    GPA2(qglColor3ui, dllColor3ui, "glColor3ui");
    GPA2(qglColor3uiv, dllColor3uiv, "glColor3uiv");
    GPA2(qglColor3us, dllColor3us, "glColor3us");
    GPA2(qglColor3usv, dllColor3usv, "glColor3usv");
    GPA2(qglColor4b, dllColor4b, "glColor4b");
    GPA2(qglColor4bv, dllColor4bv, "glColor4bv");
    GPA2(qglColor4d, dllColor4d, "glColor4d");
    GPA2(qglColor4dv, dllColor4dv, "glColor4dv");
    GPA2(qglColor4f, dllColor4f, "glColor4f");
    GPA2(qglColor4fv, dllColor4fv, "glColor4fv");
    GPA2(qglColor4i, dllColor4i, "glColor4i");
    GPA2(qglColor4iv, dllColor4iv, "glColor4iv");
    GPA2(qglColor4s, dllColor4s, "glColor4s");
    GPA2(qglColor4sv, dllColor4sv, "glColor4sv");
    GPA2(qglColor4ub, dllColor4ub, "glColor4ub");
    GPA2(qglColor4ubv, dllColor4ubv, "glColor4ubv");
    GPA2(qglColor4ui, dllColor4ui, "glColor4ui");
    GPA2(qglColor4uiv, dllColor4uiv, "glColor4uiv");
    GPA2(qglColor4us, dllColor4us, "glColor4us");
    GPA2(qglColor4usv, dllColor4usv, "glColor4usv");
    GPA2(qglColorMask, dllColorMask, "glColorMask");
    GPA2(qglColorMaterial, dllColorMaterial, "glColorMaterial");
    GPA2(qglColorPointer, dllColorPointer, "glColorPointer");
    GPA2(qglCopyPixels, dllCopyPixels, "glCopyPixels");
    GPA2(qglCopyTexImage1D, dllCopyTexImage1D, "glCopyTexImage1D");
    GPA2(qglCopyTexImage2D, dllCopyTexImage2D, "glCopyTexImage2D");
    GPA2(qglCopyTexSubImage1D, dllCopyTexSubImage1D, "glCopyTexSubImage1D");
    GPA2(qglCopyTexSubImage2D, dllCopyTexSubImage2D, "glCopyTexSubImage2D");
    GPA2(qglCullFace, dllCullFace, "glCullFace");
    GPA2(qglDeleteLists, dllDeleteLists, "glDeleteLists");
    GPA2(qglDeleteTextures, dllDeleteTextures, "glDeleteTextures");
    GPA2(qglDepthFunc, dllDepthFunc, "glDepthFunc");
    GPA2(qglDepthMask, dllDepthMask, "glDepthMask");
    GPA2(qglDepthRange, dllDepthRange, "glDepthRange");
    GPA2(qglDisable, dllDisable, "glDisable");
    GPA2(qglDisableClientState, dllDisableClientState, "glDisableClientState");
    GPA2(qglDrawArrays, dllDrawArrays, "glDrawArrays");
    GPA2(qglDrawBuffer, dllDrawBuffer, "glDrawBuffer");
    GPA2(qglDrawElements, dllDrawElements, "glDrawElements");
    GPA2(qglDrawPixels, dllDrawPixels, "glDrawPixels");
    GPA2(qglEdgeFlag, dllEdgeFlag, "glEdgeFlag");
    GPA2(qglEdgeFlagPointer, dllEdgeFlagPointer, "glEdgeFlagPointer");
    GPA2(qglEdgeFlagv, dllEdgeFlagv, "glEdgeFlagv");
    GPA2(qglEnable, dllEnable, "glEnable");
    GPA2(qglEnableClientState, dllEnableClientState, "glEnableClientState");
    GPA2(qglEnd, dllEnd, "glEnd");
    GPA2(qglEndList, dllEndList, "glEndList");
    GPA2(qglEvalCoord1d, dllEvalCoord1d, "glEvalCoord1d");
    GPA2(qglEvalCoord1dv, dllEvalCoord1dv, "glEvalCoord1dv");
    GPA2(qglEvalCoord1f, dllEvalCoord1f, "glEvalCoord1f");
    GPA2(qglEvalCoord1fv, dllEvalCoord1fv, "glEvalCoord1fv");
    GPA2(qglEvalCoord2d, dllEvalCoord2d, "glEvalCoord2d");
    GPA2(qglEvalCoord2dv, dllEvalCoord2dv, "glEvalCoord2dv");
    GPA2(qglEvalCoord2f, dllEvalCoord2f, "glEvalCoord2f");
    GPA2(qglEvalCoord2fv, dllEvalCoord2fv, "glEvalCoord2fv");
    GPA2(qglEvalMesh1, dllEvalMesh1, "glEvalMesh1");
    GPA2(qglEvalMesh2, dllEvalMesh2, "glEvalMesh2");
    GPA2(qglEvalPoint1, dllEvalPoint1, "glEvalPoint1");
    GPA2(qglEvalPoint2, dllEvalPoint2, "glEvalPoint2");
    GPA2(qglFeedbackBuffer, dllFeedbackBuffer, "glFeedbackBuffer");
    GPA2(qglFinish, dllFinish, "glFinish");
    GPA2(qglFlush, dllFlush, "glFlush");
    GPA2(qglFogf, dllFogf, "glFogf");
    GPA2(qglFogfv, dllFogfv, "glFogfv");
    GPA2(qglFogi, dllFogi, "glFogi");
    GPA2(qglFogiv, dllFogiv, "glFogiv");
    GPA2(qglFrontFace, dllFrontFace, "glFrontFace");
    GPA2(qglFrustum, dllFrustum, "glFrustum");
    GPA2(qglGenLists, dllGenLists, "glGenLists");
    GPA2(qglGenTextures, dllGenTextures, "glGenTextures");
    GPA2(qglGetBooleanv, dllGetBooleanv, "glGetBooleanv");
    GPA2(qglGetClipPlane, dllGetClipPlane, "glGetClipPlane");
    GPA2(qglGetDoublev, dllGetDoublev, "glGetDoublev");
    GPA2(qglGetError, dllGetError, "glGetError");
    GPA2(qglGetFloatv, dllGetFloatv, "glGetFloatv");
    GPA2(qglGetIntegerv, dllGetIntegerv, "glGetIntegerv");
    GPA2(qglGetLightfv, dllGetLightfv, "glGetLightfv");
    GPA2(qglGetLightiv, dllGetLightiv, "glGetLightiv");
    GPA2(qglGetMapdv, dllGetMapdv, "glGetMapdv");
    GPA2(qglGetMapfv, dllGetMapfv, "glGetMapfv");
    GPA2(qglGetMapiv, dllGetMapiv, "glGetMapiv");
    GPA2(qglGetMaterialfv, dllGetMaterialfv, "glGetMaterialfv");
    GPA2(qglGetMaterialiv, dllGetMaterialiv, "glGetMaterialiv");
    GPA2(qglGetPixelMapfv, dllGetPixelMapfv, "glGetPixelMapfv");
    GPA2(qglGetPixelMapuiv, dllGetPixelMapuiv, "glGetPixelMapuiv");
    GPA2(qglGetPixelMapusv, dllGetPixelMapusv, "glGetPixelMapusv");
    GPA2(qglGetPointerv, dllGetPointerv, "glGetPointerv");
    GPA2(qglGetPolygonStipple, dllGetPolygonStipple, "glGetPolygonStipple");
    GPA2(qglGetString, dllGetString, "glGetString");
    GPA2(qglGetTexEnvfv, dllGetTexEnvfv, "glGetTexEnvfv");
    GPA2(qglGetTexEnviv, dllGetTexEnviv, "glGetTexEnviv");
    GPA2(qglGetTexGendv, dllGetTexGendv, "glGetTexGendv");
    GPA2(qglGetTexGenfv, dllGetTexGenfv, "glGetTexGenfv");
    GPA2(qglGetTexGeniv, dllGetTexGeniv, "glGetTexGeniv");
    GPA2(qglGetTexImage, dllGetTexImage, "glGetTexImage");
    GPA2(qglGetTexLevelParameterfv, dllGetTexLevelParameterfv, "glGetLevelParameterfv");
    GPA2(qglGetTexLevelParameteriv, dllGetTexLevelParameteriv, "glGetLevelParameteriv");
    GPA2(qglGetTexParameterfv, dllGetTexParameterfv, "glGetTexParameterfv");
    GPA2(qglGetTexParameteriv, dllGetTexParameteriv, "glGetTexParameteriv");
    GPA2(qglHint, dllHint, "glHint");
    GPA2(qglIndexMask, dllIndexMask, "glIndexMask");
    GPA2(qglIndexPointer, dllIndexPointer, "glIndexPointer");
    GPA2(qglIndexd, dllIndexd, "glIndexd");
    GPA2(qglIndexdv, dllIndexdv, "glIndexdv");
    GPA2(qglIndexf, dllIndexf, "glIndexf");
    GPA2(qglIndexfv, dllIndexfv, "glIndexfv");
    GPA2(qglIndexi, dllIndexi, "glIndexi");
    GPA2(qglIndexiv, dllIndexiv, "glIndexiv");
    GPA2(qglIndexs, dllIndexs, "glIndexs");
    GPA2(qglIndexsv, dllIndexsv, "glIndexsv");
    GPA2(qglIndexub, dllIndexub, "glIndexub");
    GPA2(qglIndexubv, dllIndexubv, "glIndexubv");
    GPA2(qglInitNames, dllInitNames, "glInitNames");
    GPA2(qglInterleavedArrays, dllInterleavedArrays, "glInterleavedArrays");
    GPA2(qglIsEnabled, dllIsEnabled, "glIsEnabled");
    GPA2(qglIsList, dllIsList, "glIsList");
    GPA2(qglIsTexture, dllIsTexture, "glIsTexture");
    GPA2(qglLightModelf, dllLightModelf, "glLightModelf");
    GPA2(qglLightModelfv, dllLightModelfv, "glLightModelfv");
    GPA2(qglLightModeli, dllLightModeli, "glLightModeli");
    GPA2(qglLightModeliv, dllLightModeliv, "glLightModeliv");
    GPA2(qglLightf, dllLightf, "glLightf");
    GPA2(qglLightfv, dllLightfv, "glLightfv");
    GPA2(qglLighti, dllLighti, "glLighti");
    GPA2(qglLightiv, dllLightiv, "glLightiv");
    GPA2(qglLineStipple, dllLineStipple, "glLineStipple");
    GPA2(qglLineWidth, dllLineWidth, "glLineWidth");
    GPA2(qglListBase, dllListBase, "glListBase");
    GPA2(qglLoadIdentity, dllLoadIdentity, "glLoadIdentity");
    GPA2(qglLoadMatrixd, dllLoadMatrixd, "glLoadMatrixd");
    GPA2(qglLoadMatrixf, dllLoadMatrixf, "glLoadMatrixf");
    GPA2(qglLoadName, dllLoadName, "glLoadName");
    GPA2(qglLogicOp, dllLogicOp, "glLogicOp");
    GPA2(qglMap1d, dllMap1d, "glMap1d");
    GPA2(qglMap1f, dllMap1f, "glMap1f");
    GPA2(qglMap2d, dllMap2d, "glMap2d");
    GPA2(qglMap2f, dllMap2f, "glMap2f");
    GPA2(qglMapGrid1d, dllMapGrid1d, "glMapGrid1d");
    GPA2(qglMapGrid1f, dllMapGrid1f, "glMapGrid1f");
    GPA2(qglMapGrid2d, dllMapGrid2d, "glMapGrid2d");
    GPA2(qglMapGrid2f, dllMapGrid2f, "glMapGrid2f");
    GPA2(qglMaterialf, dllMaterialf, "glMaterialf");
    GPA2(qglMaterialfv, dllMaterialfv, "glMaterialfv");
    GPA2(qglMateriali, dllMateriali, "glMateriali");
    GPA2(qglMaterialiv, dllMaterialiv, "glMaterialiv");
    GPA2(qglMatrixMode, dllMatrixMode, "glMatrixMode");
    GPA2(qglMultMatrixd, dllMultMatrixd, "glMultMatrixd");
    GPA2(qglMultMatrixf, dllMultMatrixf, "glMultMatrixf");
    GPA2(qglNewList, dllNewList, "glNewList");
    GPA2(qglNormal3b, dllNormal3b, "glNormal3b");
    GPA2(qglNormal3bv, dllNormal3bv, "glNormal3bv");
    GPA2(qglNormal3d, dllNormal3d, "glNormal3d");
    GPA2(qglNormal3dv, dllNormal3dv, "glNormal3dv");
    GPA2(qglNormal3f, dllNormal3f, "glNormal3f");
    GPA2(qglNormal3fv, dllNormal3fv, "glNormal3fv");
    GPA2(qglNormal3i, dllNormal3i, "glNormal3i");
    GPA2(qglNormal3iv, dllNormal3iv, "glNormal3iv");
    GPA2(qglNormal3s, dllNormal3s, "glNormal3s");
    GPA2(qglNormal3sv, dllNormal3sv, "glNormal3sv");
    GPA2(qglNormalPointer, dllNormalPointer, "glNormalPointer");
    GPA2(qglOrtho, dllOrtho, "glOrtho");
    GPA2(qglPassThrough, dllPassThrough, "glPassThrough");
    GPA2(qglPixelMapfv, dllPixelMapfv, "glPixelMapfv");
    GPA2(qglPixelMapuiv, dllPixelMapuiv, "glPixelMapuiv");
    GPA2(qglPixelMapusv, dllPixelMapusv, "glPixelMapusv");
    GPA2(qglPixelStoref, dllPixelStoref, "glPixelStoref");
    GPA2(qglPixelStorei, dllPixelStorei, "glPixelStorei");
    GPA2(qglPixelTransferf, dllPixelTransferf, "glPixelTransferf");
    GPA2(qglPixelTransferi, dllPixelTransferi, "glPixelTransferi");
    GPA2(qglPixelZoom, dllPixelZoom, "glPixelZoom");
    GPA2(qglPointSize, dllPointSize, "glPointSize");
    GPA2(qglPolygonMode, dllPolygonMode, "glPolygonMode");
    GPA2(qglPolygonOffset, dllPolygonOffset, "glPolygonOffset");
    GPA2(qglPolygonStipple, dllPolygonStipple, "glPolygonStipple");
    GPA2(qglPopAttrib, dllPopAttrib, "glPopAttrib");
    GPA2(qglPopClientAttrib, dllPopClientAttrib, "glPopClientAttrib");
    GPA2(qglPopMatrix, dllPopMatrix, "glPopMatrix");
    GPA2(qglPopName, dllPopName, "glPopName");
    GPA2(qglPrioritizeTextures, dllPrioritizeTextures, "glPrioritizeTextures");
    GPA2(qglPushAttrib, dllPushAttrib, "glPushAttrib");
    GPA2(qglPushClientAttrib, dllPushClientAttrib, "glPushClientAttrib");
    GPA2(qglPushMatrix, dllPushMatrix, "glPushMatrix");
    GPA2(qglPushName, dllPushName, "glPushName");
    GPA2(qglRasterPos2d, dllRasterPos2d, "glRasterPos2d");
    GPA2(qglRasterPos2dv, dllRasterPos2dv, "glRasterPos2dv");
    GPA2(qglRasterPos2f, dllRasterPos2f, "glRasterPos2f");
    GPA2(qglRasterPos2fv, dllRasterPos2fv, "glRasterPos2fv");
    GPA2(qglRasterPos2i, dllRasterPos2i, "glRasterPos2i");
    GPA2(qglRasterPos2iv, dllRasterPos2iv, "glRasterPos2iv");
    GPA2(qglRasterPos2s, dllRasterPos2s, "glRasterPos2s");
    GPA2(qglRasterPos2sv, dllRasterPos2sv, "glRasterPos2sv");
    GPA2(qglRasterPos3d, dllRasterPos3d, "glRasterPos3d");
    GPA2(qglRasterPos3dv, dllRasterPos3dv, "glRasterPos3dv");
    GPA2(qglRasterPos3f, dllRasterPos3f, "glRasterPos3f");
    GPA2(qglRasterPos3fv, dllRasterPos3fv, "glRasterPos3fv");
    GPA2(qglRasterPos3i, dllRasterPos3i, "glRasterPos3i");
    GPA2(qglRasterPos3iv, dllRasterPos3iv, "glRasterPos3iv");
    GPA2(qglRasterPos3s, dllRasterPos3s, "glRasterPos3s");
    GPA2(qglRasterPos3sv, dllRasterPos3sv, "glRasterPos3sv");
    GPA2(qglRasterPos4d, dllRasterPos4d, "glRasterPos4d");
    GPA2(qglRasterPos4dv, dllRasterPos4dv, "glRasterPos4dv");
    GPA2(qglRasterPos4f, dllRasterPos4f, "glRasterPos4f");
    GPA2(qglRasterPos4fv, dllRasterPos4fv, "glRasterPos4fv");
    GPA2(qglRasterPos4i, dllRasterPos4i, "glRasterPos4i");
    GPA2(qglRasterPos4iv, dllRasterPos4iv, "glRasterPos4iv");
    GPA2(qglRasterPos4s, dllRasterPos4s, "glRasterPos4s");
    GPA2(qglRasterPos4sv, dllRasterPos4sv, "glRasterPos4sv");
    GPA2(qglReadBuffer, dllReadBuffer, "glReadBuffer");
    GPA2(qglReadPixels, dllReadPixels, "glReadPixels");
    GPA2(qglRectd, dllRectd, "glRectd");
    GPA2(qglRectdv, dllRectdv, "glRectdv");
    GPA2(qglRectf, dllRectf, "glRectf");
    GPA2(qglRectfv, dllRectfv, "glRectfv");
    GPA2(qglRecti, dllRecti, "glRecti");
    GPA2(qglRectiv, dllRectiv, "glRectiv");
    GPA2(qglRects, dllRects, "glRects");
    GPA2(qglRectsv, dllRectsv, "glRectsv");
    GPA2(qglRenderMode, dllRenderMode, "glRenderMode");
    GPA2(qglRotated, dllRotated, "glRotated");
    GPA2(qglRotatef, dllRotatef, "glRotatef");
    GPA2(qglScaled, dllScaled, "glScaled");
    GPA2(qglScalef, dllScalef, "glScalef");
    GPA2(qglScissor, dllScissor, "glScissor");
    GPA2(qglSelectBuffer, dllSelectBuffer, "glSelectBuffer");
    GPA2(qglShadeModel, dllShadeModel, "glShadeModel");
    GPA2(qglStencilFunc, dllStencilFunc, "glStencilFunc");
    GPA2(qglStencilMask, dllStencilMask, "glStencilMask");
    GPA2(qglStencilOp, dllStencilOp, "glStencilOp");
    GPA2(qglTexCoord1d, dllTexCoord1d, "glTexCoord1d");
    GPA2(qglTexCoord1dv, dllTexCoord1dv, "glTexCoord1dv");
    GPA2(qglTexCoord1f, dllTexCoord1f, "glTexCoord1f");
    GPA2(qglTexCoord1fv, dllTexCoord1fv, "glTexCoord1fv");
    GPA2(qglTexCoord1i, dllTexCoord1i, "glTexCoord1i");
    GPA2(qglTexCoord1iv, dllTexCoord1iv, "glTexCoord1iv");
    GPA2(qglTexCoord1s, dllTexCoord1s, "glTexCoord1s");
    GPA2(qglTexCoord1sv, dllTexCoord1sv, "glTexCoord1sv");
    GPA2(qglTexCoord2d, dllTexCoord2d, "glTexCoord2d");
    GPA2(qglTexCoord2dv, dllTexCoord2dv, "glTexCoord2dv");
    GPA2(qglTexCoord2f, dllTexCoord2f, "glTexCoord2f");
    GPA2(qglTexCoord2fv, dllTexCoord2fv, "glTexCoord2fv");
    GPA2(qglTexCoord2i, dllTexCoord2i, "glTexCoord2i");
    GPA2(qglTexCoord2iv, dllTexCoord2iv, "glTexCoord2iv");
    GPA2(qglTexCoord2s, dllTexCoord2s, "glTexCoord2s");
    GPA2(qglTexCoord2sv, dllTexCoord2sv, "glTexCoord2sv");
    GPA2(qglTexCoord3d, dllTexCoord3d, "glTexCoord3d");
    GPA2(qglTexCoord3dv, dllTexCoord3dv, "glTexCoord3dv");
    GPA2(qglTexCoord3f, dllTexCoord3f, "glTexCoord3f");
    GPA2(qglTexCoord3fv, dllTexCoord3fv, "glTexCoord3fv");
    GPA2(qglTexCoord3i, dllTexCoord3i, "glTexCoord3i");
    GPA2(qglTexCoord3iv, dllTexCoord3iv, "glTexCoord3iv");
    GPA2(qglTexCoord3s, dllTexCoord3s, "glTexCoord3s");
    GPA2(qglTexCoord3sv, dllTexCoord3sv, "glTexCoord3sv");
    GPA2(qglTexCoord4d, dllTexCoord4d, "glTexCoord4d");
    GPA2(qglTexCoord4dv, dllTexCoord4dv, "glTexCoord4dv");
    GPA2(qglTexCoord4f, dllTexCoord4f, "glTexCoord4f");
    GPA2(qglTexCoord4fv, dllTexCoord4fv, "glTexCoord4fv");
    GPA2(qglTexCoord4i, dllTexCoord4i, "glTexCoord4i");
    GPA2(qglTexCoord4iv, dllTexCoord4iv, "glTexCoord4iv");
    GPA2(qglTexCoord4s, dllTexCoord4s, "glTexCoord4s");
    GPA2(qglTexCoord4sv, dllTexCoord4sv, "glTexCoord4sv");
    GPA2(qglTexCoordPointer, dllTexCoordPointer, "glTexCoordPointer");
    GPA2(qglTexEnvf, dllTexEnvf, "glTexEnvf");
    GPA2(qglTexEnvfv, dllTexEnvfv, "glTexEnvfv");
    GPA2(qglTexEnvi, dllTexEnvi, "glTexEnvi");
    GPA2(qglTexEnviv, dllTexEnviv, "glTexEnviv");
    GPA2(qglTexGend, dllTexGend, "glTexGend");
    GPA2(qglTexGendv, dllTexGendv, "glTexGendv");
    GPA2(qglTexGenf, dllTexGenf, "glTexGenf");
    GPA2(qglTexGenfv, dllTexGenfv, "glTexGenfv");
    GPA2(qglTexGeni, dllTexGeni, "glTexGeni");
    GPA2(qglTexGeniv, dllTexGeniv, "glTexGeniv");
    GPA2(qglTexImage1D, dllTexImage1D, "glTexImage1D");
    GPA2(qglTexImage2D, dllTexImage2D, "glTexImage2D");
    GPA2(qglTexParameterf, dllTexParameterf, "glTexParameterf");
    GPA2(qglTexParameterfv, dllTexParameterfv, "glTexParameterfv");
    GPA2(qglTexParameteri, dllTexParameteri, "glTexParameteri");
    GPA2(qglTexParameteriv, dllTexParameteriv, "glTexParameteriv");
    GPA2(qglTexSubImage1D, dllTexSubImage1D, "glTexSubImage1D");
    GPA2(qglTexSubImage2D, dllTexSubImage2D, "glTexSubImage2D");
    GPA2(qglTranslated, dllTranslated, "glTranslated");
    GPA2(qglTranslatef, dllTranslatef, "glTranslatef");
    GPA2(qglVertex2d, dllVertex2d, "glVertex2d");
    GPA2(qglVertex2dv, dllVertex2dv, "glVertex2dv");
    GPA2(qglVertex2f, dllVertex2f, "glVertex2f");
    GPA2(qglVertex2fv, dllVertex2fv, "glVertex2fv");
    GPA2(qglVertex2i, dllVertex2i, "glVertex2i");
    GPA2(qglVertex2iv, dllVertex2iv, "glVertex2iv");
    GPA2(qglVertex2s, dllVertex2s, "glVertex2s");
    GPA2(qglVertex2sv, dllVertex2sv, "glVertex2sv");
    GPA2(qglVertex3d, dllVertex3d, "glVertex3d");
    GPA2(qglVertex3dv, dllVertex3dv, "glVertex3dv");
    GPA2(qglVertex3f, dllVertex3f, "glVertex3f");
    GPA2(qglVertex3fv, dllVertex3fv, "glVertex3fv");
    GPA2(qglVertex3i, dllVertex3i, "glVertex3i");
    GPA2(qglVertex3iv, dllVertex3iv, "glVertex3iv");
    GPA2(qglVertex3s, dllVertex3s, "glVertex3s");
    GPA2(qglVertex3sv, dllVertex3sv, "glVertex3sv");
    GPA2(qglVertex4d, dllVertex4d, "glVertex4d");
    GPA2(qglVertex4dv, dllVertex4dv, "glVertex4dv");
    GPA2(qglVertex4f, dllVertex4f, "glVertex4f");
    GPA2(qglVertex4fv, dllVertex4fv, "glVertex4fv");
    GPA2(qglVertex4i, dllVertex4i, "glVertex4i");
    GPA2(qglVertex4iv, dllVertex4iv, "glVertex4iv");
    GPA2(qglVertex4s, dllVertex4s, "glVertex4s");
    GPA2(qglVertex4sv, dllVertex4sv, "glVertex4sv");
